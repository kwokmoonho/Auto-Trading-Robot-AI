# ============================================================================
# Joel Greenblatt's Magic Formular
# Author - KM
# =============================================================================
...
class MagicFormular:
    ...
    def __init__(self, tickers):
        ...
        self.indx = ["EBITDA","D&A","MarketCap","NetIncome","CashFlowOps","Capex","CurrAsset",
        "CurrLiab","PPE","BookValue","TotDebt","DivYield"]
        self.all_stats = {}
        print("Running magic formular....")
    ...
    def dataHandling(self):
        for ticker in self.tickers:
            ...
            #getting balance sheet data from yahoo finance for the given ticker
                ...
                self.financial_dir[ticker] = temp_dir
            except:
        ...
        for ticker in self.tickers:
            try:
                ...
                self.all_stats['{}'.format(ticker)] = ticker_stats
            except:
